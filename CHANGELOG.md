...
* Optimized load performance by using more intelligent logic to scaffold a `Record` instance and caching access to internal `Field` objects that are set during the process. 
